(() => {
  ...
  var CALLBACK_HASH = /(?:^|&)(?:invite_token|confirmation_token|recovery_token)=/;
  ...
  function redirectToLogin() {
    ...
    const destination = window.location.pathname + window.location.search + (callbackHash ? "" : window.location.hash);
